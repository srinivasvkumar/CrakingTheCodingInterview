...
print("strings comparison by trail method - many times wrong:-",identifyPermutation(str1,str2)) #yeilds wrong result

print("strings comparison by counter method:-",check_permutation(str1,str2)) #correct algo

print("strings comparison by sort method:-",comBySort(str1,str2)) #compare by sorting 
